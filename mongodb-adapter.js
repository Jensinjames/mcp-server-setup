        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        docs = _a.sent();
                        return [2 /*return*/, docs.map(this.toExternalModel)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        docs = _a.sent();
                        return [2 /*return*/, docs.map(this.toExternalUser)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.users.findOneAndUpdate({ _id: new mongodb_1.ObjectId(id) }, { $set: updateData }, { returnDocument: 'after' })];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        ...
                        if (error_7 instanceof Error && error_7.message.includes('duplicate key')) {
